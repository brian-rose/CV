...
Ford, R.R.* and \underline{B.E.J. Rose}: A Southern Ocean Multidecadal Oscillator Forced by Deep Convection. \emph{\textbf{Revised} for Geophys. Res. Lett.}
\vspace{0.2 cm}
...
\underline{Rose, B.E.J.}, R.R. Ford*, A. Banihirwe, M.D. Camron, J. Clyne, O. Eroglu, K. FitzGerald, B. Freeman*, M.A. Grover, J. Kent, R. May, K. Paul, K.R. Tyle, A. Zacharias: Pythia Foundations: A community learning resource for Python-based computing in the geosciences. \emph{\textbf{In revision} for J. Open Source Education}
\vspace{0.2 cm}
...
\years{2025 -- } Aiden Alwang (PhD written exam expected January 2026)
