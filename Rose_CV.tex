...
\years{2018} A. Dai, D. Huang, B.E.J. Rose, J. Zhu and X. Tian, New Estimates of the Equilibrium Climate Sensitivity in Coupled Climate Models (to be revised for Climate Dynamics)
...
\years{2014 -- }
  \href{https://github.com/brian-rose/climlab}{CLIMLAB}, a Python-based toolkit for interactive, process-oriented climate modeling

\years{2015 -- }
  \href{https://github.com/brian-rose/pyCESM}{pyCESM}, a Python-based analysis package for output from the Community Earth System Model
...
\subsection*{COURSES AT THE UNIVERSITY AT ALBANY}\label{courses}
