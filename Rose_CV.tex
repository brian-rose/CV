...
Gyawali, N.*, \underline{B.E.J. Rose} and C.R. Ferguson: Understanding the Applicability of Satellite Sounder Estimates of Large-scale Vertical Motion for Identifying the Ratio of Locally and Synoptically Forced Precipitation Events. \emph{\textbf{In revision} for J. Geophys. Res. Atmospheres}
\vspace{0.2 cm}
...
Zhuo, L.*, \underline{Rose, B.E.J.} et al., Regional SST Control of Saharan Near-Surface Temperature: Sensitivity and Dynamical Mechanisms. \emph{\textbf{In prep.} for J. Climate}.
\vspace{0.2 cm}
